describe("CampoMinado", function() {
  ...
  describe("Check bombs", function() {
    ...
    it("distance in one bomb", function() {
      jQuery('body').append('<div id="game1"></div>');
      game.setVars(jQuery('#game1'), 4, 4, 0);
      game.drawBoard();
      game.initializeBombs();
      // [1][1][1]
      // [1][x][1]
      // [1][1][1]
      game.locationBombs.push([1,1]);
      game.bombs[1][0] = 'x';
      game.getDistances();
    ...
    //   jQuery('body').append('<div id="game1" style="display:block;"></div>');
    //   game.setVars(jQuery('#game1'), 4, 4, 0);
    //   game.drawBoard();
    //   game.initializeBombs();
    //   // [x][2][x]
    //   // [1][2][1]
    //   // [0][0][0]
    //   game.locationBombs.push([0,0]);
    //   game.locationBombs.push([2,0]);
    //   game.bombs[0][0] = 'x';
    //   game.bombs[2][0] = 'x';
    //   game.getDistances();
    // });
